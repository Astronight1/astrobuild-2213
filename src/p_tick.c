...
void P_Ticker(boolean run)
{
	...
	if (playeringame[consoleplayer] && players[consoleplayer].mo && !P_MobjWasRemoved(players[consoleplayer].mo) && !players[consoleplayer].spectator && !players[consoleplayer].powers[pw_super])
