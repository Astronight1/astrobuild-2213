...
consvar_t cv_knucklesfix = CVAR_INIT ("knucklesfix", "Off", 0, CV_OnOff, NULL);
...
static void SendNameAndColor(void)
{
	...
	// Don't change skin if the server doesn't want you to. || NUH UH
